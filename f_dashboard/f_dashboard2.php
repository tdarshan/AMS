...
<head>
    ...
    <link rel="stylesheet" href="f_dashboardStyle.css">
...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom"><i class="bi bi-tree"></i>AgroProject</div>
            </a>
            <div class="list-group list-group-flush my-3">
                <a href="f_dashboard.php" class="list-group-item list-group-item-action bg-transparent second-text active"><i class="fas fa-tachometer-alt me-2"></i>Dashboard</a>
                ...
                <a href="f_dashboard2.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fas fa-gift me-2"></i>Products</a>
        ...
        <div id="page-content-wrapper">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="f_profile.php">Profile</a>
                                </li>
            ...
            <div class="container-fluid px-4">
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2">
                                    <?php
                                        $sql ="SELECT * FROM `rent_equip` WHERE f_email = '". $_SESSION['email'] ."'";
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Your Products</h3>
                    <div class="col">
                            ...
                            <tbody class="bg-white">
                                ...
                                ?>
                                    <tr class="align-middle">
                                        ...
                                        <td> <?php echo $fetch['pdesc']; ?> </td>
                                        <!-- <td> <button class="btn btn-danger" onclick="confirm_del(<?php echo $fetch['id'];?>)">
    ...
    <script>
        function confirm_del(id){
            if(confirm('Do you really want to delete this item?')){
                window.location.href = "f_del_product.php?del="+id;
            }
        }
    </script>
</body>
